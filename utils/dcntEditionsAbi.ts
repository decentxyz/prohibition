export const EditionsAbi = [
  ...
  {
    inputs: [{ internalType: "uint32", name: "newCap", type: "uint32" }],
    name: "adjustCap",
    outputs: [],
  ...
  },
  {
    ...
    name: "edition",
    outputs: [
      { internalType: "bool", name: "hasAdjustableCap", type: "bool" },
      { internalType: "bool", name: "isSoulbound", type: "bool" },
      { internalType: "uint32", name: "maxTokens", type: "uint32" },
      { internalType: "uint32", name: "maxTokenPurchase", type: "uint32" },
      { internalType: "uint32", name: "presaleStart", type: "uint32" },
      { internalType: "uint32", name: "presaleEnd", type: "uint32" },
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          {
            internalType: "bytes",
            name: "metadataRendererInit",
            type: "bytes",
          },
          { internalType: "address", name: "parentIP", type: "address" },
        ],
        internalType: "struct MetadataConfig",
      ...
      },
      {
        components: [
          ...
          { internalType: "uint88", name: "minBalance", type: "uint88" },
          { internalType: "enum SaleType", name: "saleType", type: "uint8" },
        ],
        internalType: "struct TokenGateConfig",
        name: "_tokenGateConfig",
        type: "tuple",
      },
  ...
  {
    inputs: [{ internalType: "uint256", name: "numReserved", type: "uint256" }],
    name: "reserveDCNT",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    inputs: [],
    name: "saleIsActive",
    outputs: [{ internalType: "bool", name: "_saleIsActive", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_presaleMerkleRoot", type: "bytes32" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "transferETH", type: "uint256" },
      { internalType: "contract ERC20[]", name: "tokens", type: "address[]" },
    ],
    name: "transferToSplit",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "operatorFilter", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint32", name: "newStart", type: "uint32" },
      { internalType: "uint32", name: "newEnd", type: "uint32" },
    ],
    name: "updatePresaleStartEnd",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
